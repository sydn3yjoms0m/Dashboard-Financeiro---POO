...
class AppFinancas(ctk.CTk):
    ...
    def __init__(self):
        ...
        self.title("Finances Pro - Painel de Fluxo Separado")
        
        # 💻 AJUSTE NATIVO: Inicia o aplicativo maximizado de forma responsiva
        self.state("zoomed")
        ...
        # =================================================================
        # 📊 WORKSPACE PRINCIPAL (3 Colunas Lado a Lado Completamente Separadas)
        # =================================================================
        ...
        self.frame_grafico_entrada.grid(row=1, column=0, sticky="nsew", padx=15, pady=15)
    ...
    def inicializar_graficos(self):
        # Gráfico da esquerda acoplado em sua respectiva coluna (Mundo das Entradas)
        ...
        # Gráfico do meio acoplado em sua respectiva coluna (Mundo dos Gastos)
    ...
    def atualizar_graficos(self):
        ...
        if entradas == 0:
            ...
            self.ax1.pie([despesas, sobra], labels=["Gasto Total", "Sobra em Caixa"], autopct="%1.1f%%", textprops={"color": "#D1D1D6", "fontsize": 8}, colors=["#FF6B6B", "#2ECC71"], wedgeprops={'edgecolor': '#121218', 'linewidth': 2})
        ...
        if not despesas_cat:
            ...
            self.ax2.pie(list(despesas_cat.values()), labels=list(despesas_cat.keys()), autopct="%1.1f%%", textprops={"color": "#D1D1D6", "fontsize": 8}, colors=["#FF6B6B", "#4FACFE", "#B19FFB", "#F7B731", "#55EFC4"], wedgeprops={'edgecolor': '#121218', 'linewidth': 2})
